            ...
            <div class="col-lg-8">
                <div class="row gx-5 row-cols-1 row-cols-md-2">
                    ...
                    <div class="col h-100">
                        ...
                        <p class="mb-0">자세히 : <a href="about_me.jsp" style="background:white; color:blue; text-decoration: none;">개발자의 현황을 살펴보세요.</a></p>
                    </div>
                </div>
            </div>
        </div>
    	...
    	<div class="card border-0 shadow rounded-3 overflow-hidden">
			...
			<div class="row">
				...
				<div class="p-4 p-md-5">
					...
					<div class="h2 fw-bolder">번호&nbsp;<%= list.get(i).getBbsID() %>
                		<div class="h2 fw-bolder">제목<a href="post_detail.jsp?bbsID=<%= list.get(i).getBbsID() %>">
							<%= list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></a></div>
                			<a class="btn btn-primary" href="post_detail.jsp?bbsID=<%= list.get(i).getBbsID() %>">
                            자세히 알아보기<i class="bi bi-arrow-right"></i></a>
                        </div>
                        <div class="card-footer text-muted">
                    	Posted on <%= list.get(i).getBbsDate().substring(0, 11) + list.get(i).getBbsDate().substring(11, 13) + "시 "
							+ list.get(i).getBbsDate().substring(14, 16) + "분 " %> by
			...
			<%
				if(pageNumber != 1){
			%>
				<a href="post_list.jsp?pageNumber=<%=pageNumber - 1 %>"
