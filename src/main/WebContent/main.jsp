...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1>웹 사이트 소개</h1>
			<p>이 웹 사이트는 부트스트랩으로 만든 JSP 웹 사이트입니다. 멘토링 발표에 사용될 목적으로 개발했습니다.
			   디자인 템플릿으로 만든 것입니다. 여기서의 주요 기능은 로그인, 회원가입, 로그아웃, 게시판 글 쓰기, 글 삭제, 글 수정 등이 구현되어 있습니다.<br><br>
			   <a class="btn btn-primary btn-pull" href="post_list.jsp" role="button">자세히 알아보기</a></p>
		</div>
	</div>
	<div class="container">
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" align="center">
				<div class="item active">
					<img src="images/배경화면1.jpg">
				</div>
				<div class="item">
					<img src="images/배경화면2.jpg">
				</div>
				<div class="item">
					<img src="images/배경화면7.jpg">
				</div>
			</div>
			<a class="left carousel-control" href="#myCarousel" data-slide="prev">
				<span class="glyphicon glyphicon-cheuron-left"></span>
			</a>
			<a class="right carousel-control" href="#myCarousel" data-slide="next">
				<span class="glyphicon glyphicon-cheuron-right"></span>
			</a>
		</div>
	</div>
	<br>
